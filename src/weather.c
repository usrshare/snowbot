...
const struct weather_id wids[] = {
	{0,   "???",                            "??","??",NULL,NULL},
	{201, "thunderstorm with rain",		"Tr","Tr","\00307","\017"},
	{202, "thunderstorm with heavy rain",	"TR","TR","\00307","\017"},
	{210, "light thunderstorm",		" t","░t","\00307","\017"},
	{211, "thunderstorm",			" T","▒T","\00307","\017"},
	{212, "heavy thunderstorm",		"TT","▓T","\00307","\017"},
	{221, "ragged thunderstorm",		"T!","T!","\00307","\017"},
	{230, "thunderstorm with light drizzle","Td","Td","\00307","\017"},
	{231, "thunderstorm with drizzle",	"TD","TD","\00307","\017"},
	{232, "thunderstorm with heavy drizzle","TD","TD","\00307","\017"},
	{300, "light intensity drizzle",	" d","░d","\00311","\017"},
	{301, "drizzle",			"dd","▒d","\00311","\017"},
	{302, "heavy intensity drizzle",	" D","▓D","\00311","\017"},
	{310, "light intensity drizzle rain",	"dr","dr","\00311","\017"},
	{311, "drizzle rain",			"DR","DR","\00311","\017"},
	{312, "heavy intensity drizzle rain",	"DR","DR","\00311","\017"},
	{313, "shower rain and drizzle",	"dr","dr","\00310","\017"},
	{314, "heavy shower rain and drizzle",	"DR","DR","\00310","\017"},
	{321, "shower drizzle",			" d"," d","\00310","\017"},
	{500, "light rain",			" r"," r","\00311","\017"},
	{501, "moderate rain",			"rr","rr","\00311","\017"},
	{502, "heavy intensity rain",		"Rr","Rr","\00311","\017"},
	{503, "very heavy rain",		"RR","RR","\00311","\017"},
	{504, "extreme rain",			"R!","R!","\00311","\017"},
	{511, "freezing rain",			"R-","R-","\00312","\017"},
	{520, "light intensity shower rain",	" r"," r","\00310","\017"},
	{521, "shower rain",			" R"," R","\00310","\017"},
	{522, "heavy intensity shower rain",	"RR","RR","\00310","\017"},
	{531, "ragged shower rain",		"R!","R!","\00310","\017"},
	{600, "light snow",			" s"," s","\00312","\017"},
	{601, "snow",				"ss","ss","\00312","\017"},
	{602, "heavy snow",			" S"," S","\00312","\017"},
	{611, "sleet",				"sl","sl",NULL,NULL},
	{612, "shower sleet",			"sl","sl","\00314","\017"},
	{615, "light rain and snow",		"rs","rs","\00312","\017"},
	{616, "rain and snow",			"RS","RS","\00312","\017"},
	{620, "light shower snow",		" s"," s","\00302","\017"},
	{621, "shower snow",			"ss","ss","\00302","\017"},
	{622, "heavy shower snow",		" S"," S","\00302","\017"},
	{701, "mist",				"mi","mi",NULL,NULL},
	{711, "smoke",				"sm","sm",NULL,NULL},
	{721, "haze",				"hz","hz",NULL,NULL},
	{731, "sand, dust whirls",		"s@","s@",NULL,NULL},
	{741, "fog",				"fg","fg",NULL,NULL},
	{751, "sand",				"sd","sd",NULL,NULL},
	{761, "dust",				"dt","dt",NULL,NULL},
	{762, "volcanic ash",			"va","va",NULL,NULL},
	{771, "squalls",			"sq","sq",NULL,NULL},
	...
	{904, "hot",				" +"," +",NULL,NULL},
	{905, "windy",				"~~","~~",NULL,NULL},
	{906, "hail",				"HL","HL","\00312","\017"},
	{951, "calm",				"cm","cm",NULL,NULL},
	{952, "light breeze",			"~1","~1",NULL,NULL},
	{953, "gentle breeze",			"~2","~2",NULL,NULL},
	{954, "moderate breeze",		"~3","~3",NULL,NULL},
	{955, "fresh breeze",			"~4","~4",NULL,NULL},
	{956, "strong breeze",			"~5","~5",NULL,NULL},
	{957, "high wind, near gale",		"~6","~6",NULL,NULL},
	{958, "gale",				"~7","~7","\002","\017"}, //B
	{959, "severe gale",			"~8","~8","\002","\017"}, //B
	{960, "storm",				" #"," #","\026","\017"}, //I
	{961, "violent storm",			"##","##","\026","\017"}, //I
	{962, "hurricane",			"H@","H@","\026","\017"}, //I
};
