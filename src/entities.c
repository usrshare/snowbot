...
size_t html_unescape(const char* restrict in_str, char* restrict out_str) {

    //out_str MUST be at least as long as strlen(in_str)+1.
    return decode_html_entities_utf8(out_str,in_str);
}
